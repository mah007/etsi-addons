...
class AssetConfigInherit (models.Model):
    ...
    model = fields.Char (string = "Model", related = 'asset_id.asset_model', readonly = True)
    asset_year  = fields.Date(string = "Year", related = 'asset_id.year', readonly = True)
    condition = fields.Selection (string = "Asset Condition", related = 'asset_id.asset_condition', readonly = True)
