...
class HrPubLicHolidayType(models.Model):
    _name ='hr.holidays.public.type'
    _description='Public Holiday Type'

    name = fields.Char(string="Name")
    line_ids = fields.One2many('hr.holidays.public.line','holiday_type',string="Holidays")
